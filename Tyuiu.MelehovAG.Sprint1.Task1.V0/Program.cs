...
using Tyuiu.MelehovAG.Sprint1.Task1.V0.Lib;

//ЗАДАНИЕ
// Написать программу, которая запрашивает у пользователя исходные данные,
// вычисляет результат по формуле x / (y - 1) и печатает его на экране.
namespace Tyuiu.MelehovAG.Sprint1.Task1.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Метод Calculate находится в библиотеке Tyuiu.MelehovAG.Sprint1.Task1.V0.Lib
