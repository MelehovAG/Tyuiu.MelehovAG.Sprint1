...
//Формулировка задания: Известно расстояние в километрах. Перевести расстояние в метры. Ответ округлите до 3 знаков после запятой.
//Что пользователь вводит? Расстояние в километрах (вещественное число)
...
namespace Tyuiu.MelehovAG.Sprint1.Task2.V30
{
    class Program
    {
